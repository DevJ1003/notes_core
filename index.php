    ...
    <div class="right-sidebar-mini right-sidebar">
      <div class="right-sidebar-panel p-0">
        <div
          ...
          data-extra-toggle="right-sidebar-dissmiss"
        >
        ...
        <div class="card shadow-none tag-details mb-0">
          <div class="card-header d-flex justify-content-between">
            ...
            <div>
              <a href="#" data-toggle="modal" data-target="#create-note"
                ><i class="ri-add-line font-size-20"></i
              ></a>
            </div>
          </div>
          <div class="card-body p-0">
            <ul class="list-inline p-3 m-0 pb-0">
              <li class="mb-3 px-2">
                <div
                  class="item d-flex align-items-center justify-content-between pb-3 border-bottom"
                >
                  ...
                  <div class="dropdown">
                    <span
                      class="dropdown-toggle dropdown-bg"
                      id="tag-dropdownMenuButton1"
                    ...
                    >
                      <a
                        class="dropdown-item"
                        data-toggle="modal"
                        data-target="#tag-rename"
                        href="#"
                        ><i class="las la-pen mr-3"></i>Rename</a
                      >
                      <a
                        class="dropdown-item"
                        ...
                        href="#"
                        ><i class="las la-trash-alt mr-3"></i>Delete</a
                      >
                    </div>
                  </div>
                </div>
    ...
    <div class="wrapper">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto navbar-list align-items-center">
                  ...
                  <li class="nav-item nav-icon dropdown mail-content">
                    <a
                      href="#"
                      class="search-toggle dropdown-toggle nav-icon-1"
                    ...
                    >
                      ...
                      <span
                        class="badge badge-primary count-mail mail rounded-circle"
                        >2</span
                      >
                    ...
                    >
                      <div class="card shadow-none m-0">
                        <div class="card-body p-0">
                          ...
                          <a
                            class="btn btn-block btn-primary position-relative text-center"
                            href="#"
                            role="button"
                          >
                            View All
                  ...
                  <li class="nav-item nav-icon dropdown mail-content">
                    ...
                    >
                      ...
                      <span
                        class="badge badge-primary count-mail rounded-circle"
                        >2</span
                      >
                      <span class="bg-primary"></span>
                    </a>
                  ...
                  <li class="caption-content">
                    ...
                    <div
                      class="dropdown-menu dropdown-menu-right w-100 border-0 py-2"
      ...
      <div class="iq-sidebar sidebar-default">
        ...
        <div class="sidebar-caption dropdown">
          ...
          <div
            class="dropdown-menu w-100 border-0 my-2"
                ...
                >
                  <li class="">
                    ...
                    >
                      ...
                      <i
                        class="las la-angle-right iq-arrow-right arrow-active"
                      ></i>
                      <i
                        class="las la-angle-down iq-arrow-right arrow-hover"
                      ></i>
                    </a>
                    <ul
                      id="user"
                  ...
                  <li class="">
                    ...
                    >
                      ...
                      <li class="">
                        <a
                          href="../backend/ui-helper-classes.html"
                          class="svg-icon"
                        >
                          <i class="">
                            <svg
                          ...
                          ><span class="">Helper classes</span>
                        </a>
                      </li>
                      <li class="">
                      ...
                      <li class="">
                        ...
                        >
                          <i class="">
                            <svg
                              class="svg-icon feather feather-list"
                              id="iq-ui-1-13"
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                              viewBox="0 0 24 24"
                      ...
                      <li class="">
                        <a href="../backend/ui-modal.html" class="svg-icon">
                          <i class="">
                            <svg
                              class="svg-icon feather feather-columns"
                              id="iq-ui-1-15"
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                              viewBox="0 0 24 24"
                      ...
                      <li class="">
                        ...
                        >
                          <i class="">
                            <svg
                              class="svg-icon feather feather-hard-drive"
                              id="iq-ui-1-19"
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                              viewBox="0 0 24 24"
                  ...
                  <li class="">
                    ...
                    >
                      ...
                      <li class="">
                        <a href="../backend/pricing-1.html" class="svg-icon">
                          <i class="">
                            <svg
                              class="svg-icon"
                              id="iq-extra-1-3-2"
                  ...
                  <li class="">
                    ...
                    >
                      <i class="">
                        <svg
                          class="svg-icon feather feather-alert-triangle"
                          id="iq-extra-1-4"
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
                          viewBox="0 0 24 24"
                    ...
                    >
                      <li class="">
                        <a href="../backend/pages-error.html" class="svg-icon">
                          <i class="">
                            <svg
                              class="svg-icon feather feather-alert-circle"
                              id="iq-extra-1-4-1"
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                              viewBox="0 0 24 24"
            ...
            <div class="card rounded shadow-none">
              <div class="card-body">
                <div class="sidebarbottom-content">
                  ...
                  <p class="mb-0">
                    Set Buisness Account To Explore Premiun Features
                  </p>
                  <button type="button" class="btn bg-primary mt-3">
                    Upgrade
                  </button>
                </div>
              </div>
          ...
          <div class="desktop-header">
              ...
              <div class="card-body write-card">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="iq-note-callapse-menu">
                    <a
                      class="iq-note-callapse-btn show-note-button"
                      data-toggle="collapse"
                      href="#collapseMenu"
                      role="button"
                    ...
                    <span class="hide-note-button d-none"
                      ><i class="las la-folder pr-2"></i>Folder</span
                    >
                  </div>
                  <div
                    class="note-right media align-items-top hide-note-button d-none"
                  >
                    <div class="mr-2">
                      <a
                        href="#"
                        class="btn view-btn body-bg"
                        data-toggle="modal"
                        data-target="#share-note"
                        >Share</a
                      >
                    </div>
                      ...
                      <div class="dropdown">
                        ...
                        >
                          <a class="dropdown-item" href="#"
                            ><i class="lar la-heart mr-3"></i>Add To
                            Favourite</a
                          >
                          <a class="dropdown-item" href="#"
                            ><i class="las la-thumbtack mr-3"></i>Mark As Pin</a
                          >
                          <a class="dropdown-item" href="#"
                            ><i class="las la-trash-alt mr-3"></i>Move to
                            Trash</a
                          >
                        </div>
                      </div>
            ...
            <div class="card topnav-right">
              <div class="card-body card-content-right">
                <ul
                  class="list-inline m-0 p-0 d-flex align-items-center justify-content-around"
                >
                      ...
                      <div class="card shadow-none m-0">
                        <div class="card-body p-0">
                          <div class="p-3">
                            <a href="#" class="iq-sub-card">
                              <div
                                class="media align-items-center cust-card pb-3 border-bottom"
                              >
                                <div class="">
                                  <img
                                    class="avatar-50 rounded-small"
                            ...
                            <a href="#" class="iq-sub-card">
                              <div
                                class="media align-items-center cust-card pt-3"
                              >
                                <div class="">
                                  <img
                                    class="avatar-50 rounded-small"
                              ...
                              >
                                ...
                                <div class="iq-full-screen">
                                  <a href="#" class="" id="btnFullscreen"
                                    ><i
                                      class="las la-expand-arrows-alt font-size-18"
                                    ></i
                                  ></a>
                                </div>
                              </div>
              ...
              <div class="card card-block card-stretch">
                <div class="card-body custom-notes-space">
                  ...
                  <div class="iq-tab-content">
                    ...
                    >
                      <ul
                        class="d-flex nav nav-pills text-center note-tab mb-3"
                        id="note-pills-tab"
                        role="tablist"
                      >
                        <li class="nav-item">
                          <a
                            class="nav-link home active show"
                            data-toggle="pill"
                            data-init="note"
                            href="#note1"
                            role="tab"
                      ...
                      <div class="media align-items-top iq-grid">
                        <div
                          class="view-btn rounded body-bg btn-dropdown filter-btn mr-3"
                        >
                          <div class="dropdown">
                            <span
                            ...
                            >
                              <div class="dropdown-item mb-3">
                                ...
                                >
                                  <h6 class="mr-4">
                                    <i class="las la-book mr-3"></i>Located In
                                  </h6>
                              ...
                              <div class="dropdown-item mb-3">
                                ...
                                >
                                  <h6 class="mr-4">
                                    <i class="las la-paste mr-3"></i>Contains
                                  </h6>
                                  <div class="form-group mb-0">
                                    <select
                                      name="type"
                              ...
                              <div class="dropdown-item mb-2">
                                ...
                                >
                                  <h6 class="mr-4">
                                    <i class="las la-calendar mr-3"></i>Created
                                  </h6>
                                  <div class="form-group mb-0">
                                    <select
                                      id="date-select"
                        ...
                        <div class="list-grid-toggle cursor-pointer">
                          <span class="icon active i-grid rounded"
                            ><i class="ri-layout-grid-line font-size-20"></i
                          ></span>
                          <span class="icon active i-list rounded"
                    ...
                    <div class="note-content tab-content">
                      <div id="note1" class="tab-pane fade active show">
                        <div
                          class="icon active animate__animated animate__fadeIn i-grid"
                        >
                          <div class="row">
                              ...
                              >
                                  ...
                                  >
                                    <div class="dropdown">
                                      ...
                                      >
                                        <a
                                          href="#"
                                          class="dropdown-item new-note1"
                                          data-toggle="modal"
                                          data-target="#new-note1"
                                          ><i class="las la-eye mr-3"></i
                                          >View</a
                                        >
                                        <a
                                          href="#"
                                ...
                                <div class="card-body rounded">
                                  ...
                                  <p class="mb-3 card-description short">
                                    Virtual Digital Marketing Course every week
                                ...
                                <div class="card-footer">
                                  ...
                                  >
                                    <a href="#" class=""
                                      ><i
                                        class="las la-user-friends mr-2 font-size-20"
                                      ></i
                                      >03 share</a
                                    >
                                    <a href="#" class=""
                                      ><i
                                        class="las la-calendar mr-2 font-size-20"
                                      ></i
                                      >12 Jan 2021</a
                                    >
                                  </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                              ...
                              >
                                ...
                                >
                                  <div
                                    class="icon iq-icon-box-2 icon-border-purple rounded"
                                  >
                                    <svg
                                      width="23"
                                      height="23"
                                ...
                                <div class="card-footer">
                                  ...
                                  >
                                    <a href="#" class=""
                                      ><i
                                        class="las la-user mr-2 font-size-20"
                                      ></i
                                      >Only You</a
                                    >
                                    <a href="#" class=""
                              ...
                              >
                                    ...
                                    >
                                      <div class="dropdown">
                                        ...
                                        >
                                          <a
                                            href="#"
                                            class="dropdown-item new-note4"
                                            data-toggle="modal"
                                            data-target="#new-note4"
                                            ><i class="las la-eye mr-3"></i
                                            >View</a
                                          >
                                          <a
                                ...
                                <div class="card-body rounded">
                                  ...
                                  <div class="checkbox mb-2">
                                    <input
                                      type="checkbox"
                                      class="checkbox-input mr-3"
                                      id="checkbox18"
                                    />
                                    <label
                                      for="checkbox18"
                                      class="note-checkbox mb-0"
                                      >Chapter 1 notes.</label
                                    >
                                  </div>
                                  <div class="checkbox mb-2">
                                    <input
                                  ...
                                  <div class="checkbox mb-2">
                                    ...
                                    <label
                                      for="checkbox20"
                                      class="note-checkbox mb-0"
                                      >Chapter 3 practical File.</label
                                    >
                                  </div>
                                </div>
                                <div class="card-footer">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <div
                                class="card card-block card-stretch card-height card-bottom-border-primary note-detail"
                              >
                                <div
                                  class="card-header d-flex justify-content-between pb-1"
                                >
                                  <div
                                    class="icon iq-icon-box-2 icon-border-primary rounded"
                                  >
                                    <svg
                                      width="23"
                                      height="23"
                                  ...
                                  >
                                    ...
                                    >
                                      <div class="dropdown">
                                        ...
                                        <div
                                          class="dropdown-menu dropdown-menu-right"
                                          aria-labelledby="note-dropdownMenuButton8"
                                          style=""
                                        >
                                          <a
                                            href="#"
                                            class="dropdown-item new-note5"
                                            data-toggle="modal"
                                            data-target="#new-note5"
                                            ><i class="las la-eye mr-3"></i
                                            >View</a
                                          >
                                          <a
                                ...
                                <div class="card-body rounded">
                                  ...
                                  <ul
                                    class="row mb-0 p-0 list-inline flex-wrap align-items-center"
                                  >
                                    <li class="col-4">
                                      <a href="#">
                                        <img
                                          src="assets/images/gallery/grid/08.jpg"
                                          class="img-fluid note-image rounded"
                                          alt=""
                                        />
                                      </a>
                                    </li>
                                    <li class="col-4">
                                      <a href="#">
                                        <img
                                          src="assets/images/gallery/grid/05.jpg"
                                          class="img-fluid note-image rounded"
                                          alt=""
                                        />
                                      </a>
                                    ...
                                    <li class="col-4">
                                      <a href="#">
                                        <img
                                          src="assets/images/gallery/grid/03.jpg"
                                          class="img-fluid note-image rounded"
                                          alt=""
                                        />
                                      </a>
                                ...
                                <div class="card-footer">
                                  <div
                                    class="d-flex align-items-center justify-content-between note-text note-text-primary"
                                  >
                                    <a href="#" class=""
                                      ><i
                                        class="las la-user-friends mr-2 font-size-20"
                            ...
                            <div class="col-lg-4 col-md-6">
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <div class="dropdown">
                                      ...
                                      <div
                                        class="dropdown-menu dropdown-menu-right"
                                        aria-labelledby="note-dropdownMenuButton9"
                                        style=""
                                      >
                                        <a
                                          href="#"
                                          class="dropdown-item new-note6"
                                          data-toggle="modal"
                                          data-target="#new-note6"
                                          ><i class="las la-eye mr-3"></i
                                          >View</a
                                        >
                                        <a
                                ...
                                <div class="card-body rounded">
                                  <h4 class="card-title">
                                    Benefits of NotePlus
                                  </h4>
                                  <p class="mb-3 card-description short">
                                    Take organized notes and share later as
                                    meeting minutes or check-list with this
                                    simple accessible Noteplus. Each note you
                                    create will be stored on a virtual page of
                                    the NotePlus. You can store groups of
                                    seperate notes. You can store an unlimited
                                    number of separate notes within the
                                    NotePlus.
                                  </p>
                                </div>
                                <div class="card-footer">
                          ...
                          <div class="row">
                            <div class="col-lg-4 col-md-6">
                              ...
                              >
                                    ...
                                    >
                                      <div class="dropdown">
                                        ...
                                        >
                                          <a
                                            href="#"
                                            class="dropdown-item new-note7"
                                            data-toggle="modal"
                                            data-target="#new-note7"
                                            ><i class="las la-eye mr-3"></i
                                            >View</a
                                          >
                                          <a
                                ...
                                <div class="card-body rounded">
                                  ...
                                  <p class="mb-3 card-description short">
                                    Need to write a summary note of the subject
                                    you just finished? NotePlus lets you do in
                                    on-the-go!
                                  </p>
                            ...
                            <div class="col-lg-4 col-md-6">
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <div class="dropdown">
                                      ...
                                      <div
                                        class="dropdown-menu dropdown-menu-right"
                                        aria-labelledby="note-dropdownMenuButton11"
                                        style=""
                                      >
                                        <a
                                          href="#"
                                          class="dropdown-item new-note8"
                                          data-toggle="modal"
                                          data-target="#new-note8"
                                          ><i class="las la-eye mr-3"></i
                                          >View</a
                                        >
                                        <a
                                ...
                                <div class="card-body rounded">
                                  ...
                                  <p class="mb-3 card-description short">
                                    Quickly note down the address and email
                                    address on NotePlus so that you can access
                                    it from anywhere.
                                  </p>
                                </div>
                                <div class="card-footer">
                            ...
                            <div class="col-lg-4 col-md-6">
                              ...
                              >
                                    ...
                                    >
                                      <div class="dropdown">
                                        ...
                                        >
                                          <a
                                            href="#"
                                            class="dropdown-item new-note9"
                                            data-toggle="modal"
                                            data-target="#new-note9"
                                            ><i class="las la-eye mr-3"></i
                                            >View</a
                                          >
                                          <a
                                ...
                                <div class="card-body rounded">
                                  <h4 class="card-title">
                                    NotePlus for Entrepreneurs
                                  </h4>
                                  <p class="mb-3 card-description short">
                                    With NotePlus, you can easily share via
                                    message, WhatsApp, emails etc. You can also
                                    save your notes and edit it later or can
                                    easily delete the note.
                                  </p>
                                </div>
                                <div class="card-footer">
                                  <div
                        ...
                        <div
                          class="icon active animate__animated animate__fadeIn i-list"
                        >
                          <div class="row">
                            <div class="col-lg-12">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>
                                        ...
                                        <span
                                          >Virtual Digital Marketing Course
                                          every week on Monday, Wednesday and
                                          Saturday</span
                                        >
                                      </td>
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        <h4 class="mb-2">
                                          Birthday Celebration
                                          <i
                                            class="las la-thumbtack ml-2 show-tab"
                                            data-show-tab="[href='#note3']"
                                          ></i>
                                        </h4>
                                        <span
                                      ...
                                      <td>
                                        <i
                                          class="las la-lock mr-2 font-size-20"
                                        ></i>
                                        Only You
                                      </td>
                                      <td>Dec 20</td>
                                    ...
                                    <tr>
                                      <td>
                                        <h4 class="mb-2">
                                          Essay Outline
                                          <i
                                            class="lar la-heart ml-2 show-tab"
                                            data-show-tab="[href='#note4']"
                                          ></i>
                                        </h4>
                                        <span
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <span
                                          >Chapter 1 notes, Chapter 2
                                          Assignment, Chapter 3 practical
                                          File.</span
                                        >
                                      </td>
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        <h4 class="mb-2">
                                          Image Notes<i
                                            class="las la-thumbtack ml-2"
                                          ></i>
                                        </h4>
                                        <span
                                          >NotePlus lets you do in
                                          on-the-go!</span
                                        >
                                      </td>
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <span
                                          >Take organized notes and share later
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <span
                                          >Need to write a summary note of the
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <span
                                          >Quickly note down the address and
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <span
                                          >With NotePlus, you can easily share
                      ...
                      <div id="note3" class="tab-pane fade">
                        ...
                        >
                          <div class="row">
                                ...
                                <div class="card-body rounded">
                                  ...
                                  >
                                    <li class="col-4">
                                      <a href="#">
                                        <img
                                          src="assets/images/gallery/grid/01.jpg"
                                    ...
                                    <li class="col-4">
                                      <a href="#">
                                        <img
                                          src="assets/images/gallery/grid/02.jpg"
                                          class="img-fluid rounded"
                                          alt=""
                                        />
                                      </a>
                            ...
                            <div class="col-lg-4 col-md-6">
                              <div
                                class="card card-block card-stretch card-height card-bottom-border-success note-detail mb-0"
                              >
                                <div
                                  class="card-header d-flex justify-content-between pb-1"
                                >
            ...
            <div class="modal-content">
              <div class="modal-body">
                <div class="popup text-left">
                  ...
                  <div class="content create-workform">
                    <p>
                      You can easily share via message, WhatsApp, emails etc.
                      You can also save your notes and edit it later or can
                      easily delete the note.
                    </p>
                    <ul class="pl-3 mb-0">
                  ...
                  <div class="content create-workform">
                    <div class="checkbox mb-2">
                      <input
                        ...
                        id="checkbox13"
                      />
                      <label for="checkbox13" class="note-checkbox mb-0"
                        >Chapter 1 notes</label
                      >
                    </div>
                    <div class="checkbox mb-2">
                      <input
                        ...
                        id="checkbox14"
                      />
                      <label for="checkbox14" class="note-checkbox mb-0"
                        >Chapter 2 Assignment</label
                      >
                    </div>
                    <div class="checkbox mb-2">
                      <input
                        ...
                        id="checkbox15"
                      />
                      <label for="checkbox15" class="note-checkbox mb-0"
                        >Chapter 3 practical File</label
                      >
                    </div>
                  </div>
                    ...
                    >
                      <li class="col-md-4 mb-4">
                        <a href="#">
                          <img
                            src="assets/images/gallery/grid/01.jpg"
                            class="img-fluid rounded avatar-150"
                            alt=""
                          />
                        </a>
                      </li>
                      ...
                      <li class="col-md-4">
                        <a href="#">
                          <img
                            src="assets/images/gallery/grid/04.jpg"
                            class="img-fluid rounded avatar-150"
                            alt=""
                          />
                        </a>
                      ...
                      <li class="col-md-4">
                        <a href="#">
                          <img
                            src="assets/images/gallery/grid/06.jpg"
                            class="img-fluid rounded avatar-150"
                            alt=""
                          />
                        </a>
            ...
            <div class="modal-content">
              <div class="modal-body">
                <div class="popup text-left">
                  ...
                  <div class="content create-workform">
                    <p>
                      Take organized notes and share later as meeting minutes or
            ...
            <div class="modal-content">
              <div class="modal-body">
                <div class="popup text-left">
                  ...
                  <div class="content create-workform">
                    <p>
                      Need to write a summary note of the subject you just
                      finished? NotePlus lets you do in on-the-go!
                    </p>
                    <p class="text-underline ellipsis-text short">
                      Https://Dribble.com/Shots/6387620
                    </p>
            ...
            <div class="modal-content">
              <div class="modal-body">
                <div class="popup text-left">
                  ...
                  <div class="content create-workform">
                    <p>
                      Quickly note down the address and email address on
                      NotePlus so that you can access it from anywhere.
                    </p>
                    <h4 class="mb-3">Shared</h4>
                    <ul class="list-inline p-0 m-0">
                      <li>
            ...
            <div class="modal-content">
              <div class="modal-body">
                <div class="popup text-left">
                  ...
                  <div class="content create-workform">
                    <p>
                      With NotePlus, you can easily share via message, WhatsApp,
                      emails etc. You can also save your notes and edit it later
                      or can easily delete the note.
                    </p>
                  </div>
                </div>
              </div>
